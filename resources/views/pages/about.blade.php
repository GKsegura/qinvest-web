            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <p class="card-description">Responsável por desenvolver as páginas do usuário
                        - como cadastro e login -, além de auxiliar em atividades de banco de dados e apoiar os
                        demais membros da equipe.</p>
                </div>
            </div>
            <div class="card">
                <div class="card-image">
                ...
                <div class="card-content">
                    ...
                    <p class="card-description">Responsável por elaborar as questões de
