<x-layout.head>
    ...
    <div class="type {{$typeCamps['background']}}" id="description">
        <div class="svg-type">
            @if ($typeCamps["id"] == 1)
