<div class="type">
    ...
    <h1>seu perfil é <span>conservador</span></h1>
    <h2>O quê isso significa?</h2>
    <p>
        Você é uma pessoa que valoriza a segurança e pretende preservar seu patrimônio. <br> Talvez não seja do seu
        interesse
        viver pelo risco e prefira opções que minimizem <br>
