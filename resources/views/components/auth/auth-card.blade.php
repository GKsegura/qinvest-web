            ...
            <div class="side-left col xs-2">
                <div class="into-side-left col xs-2">
                    <div class="square-form">
                        <div class="text-left-form">o próximo <br> passo na sua <br><span
                                class="highlighted">jornada</span>
                        </div>
            ...
            <div class="side-right col xs-2">
                <div class="into-side-right ">
                    <div class="text-right-form ">
                        Olá! <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 45 45"
                            fill="none">
                            <path
